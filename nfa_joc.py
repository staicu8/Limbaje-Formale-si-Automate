...
lista_camere = config_joc["states"]
miscarile_permise = config_joc["sigma"] 
tranzitii = config_joc["routes"]
camera_initiala = config_joc["start"][0] 
camera_iesire = config_joc["final"][0]
